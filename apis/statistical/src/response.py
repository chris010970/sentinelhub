...
class Response:
    ...
    def __init__( self, data, ids=None, verbose=False ):
    ...
    def convertToDataFrame( self, data ):
        ...
        for item in data[ 'data' ]:
            ...
            if 'outputs' in item:
                ...
                # print error message
                if 'error' in item and self._verbose:
                    print( '{_from} - {_to}: {error_msg}'.format(  _from=item[ 'interval' ][ 'from' ],
                                                             _to=item[ 'interval' ][ 'from' ],
                                                             error_msg=data[ 'data'][ 0 ][ 'error'][ 'message'] ) )
